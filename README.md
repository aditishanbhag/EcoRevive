...
- Responsive design with a custom stylesheet
...
- `marketplace.html` — Browse and buy products
- `signup.html` — User registration
- `login.html` — User login
- `tracker.html` — Personal environmental impact tracker
- `awareness.html` — Eco-awareness articles (earns EcoPoints)
